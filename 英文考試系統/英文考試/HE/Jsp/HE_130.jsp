...
<% 
   ...
   String strTitle1 = "考試成績查詢(查詢條件-考試日期)"; 
...
function Maintain(){
	switch(event.srcElement.name){	
		case "queryBN":
			if(H_CheckDateMM(document.getElementById("F1").value,1,"考試日期區間1")==false){return;}
			if(H_CheckDateMM(document.getElementById("F2").value,1,"考試日期區間2")==false){return;}
